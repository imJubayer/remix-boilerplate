...
export const loader = async () => {
  return json(await categoryService.addLoader());
};

export const action = async (actionFunctionArgs: ActionFunctionArgs) => {
  return await categoryService.createAction(actionFunctionArgs);
};
...
export default function CategoryAdd() {
  ...
  const categoriesDropDown = categories.map((category, key) => {
    return (
  ...
  return (
    <>
      <div className="d-flex flex-wrap flex-stack mb-6">
        <h3 className="text-gray-600 fw-bold my-2">Add Category</h3>
      </div>
