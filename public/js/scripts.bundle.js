      ...
      (e = document.querySelector("#kt_app_sidebar_navs_wrappers")),
        ...
        t &&
          t.addEventListener("shown.bs.collapse", (t) => {
            ...
            e.scroll({ top: n, behavior: "smooth" });
          }),
        n &&
          (function () {
            ...
            KTUtil.on(n, '[data-kt-element="project"]', "click", function (n) {
              ...
              e
                ...
                .setAttribute("src", i.getAttribute("src")),
                (e.querySelector('[data-kt-element="title"]').innerText =
                  r.innerText),
                (e.querySelector('[data-kt-element="desc"]').innerText =
                  o.innerText),
